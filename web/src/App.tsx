...
export default function App() {
  ...
  return (
    <div className="flex-1 flex flex-col h-full justify-between">
        ...
        {currentTab === 'settings' && (
          <div>
            <div className="mb-4">
              ...
              <p className="text-xs text-textSecondary mt-0.5">リマインド通知とデータの管理</p>
            </div>

            <div className="space-y-3">
              <div className="bg-surface border border-borderSubtle rounded-2xl p-4 shadow-sm flex items-center justify-between">
                <div>
              ...
              <div className="bg-surface border border-borderSubtle rounded-2xl p-4 shadow-sm">
                <div className="flex items-center gap-1.5 text-xs font-bold text-accent mb-1">
                  <ShieldCheck size={16} /> プライバシーの約束
                </div>
                <p className="text-xs text-textSecondary leading-relaxed">
                  実験ログや振り返りメモは、学校・先生・外部に共有されることは一切ありません。
                </p>
              </div>
              ...
              <button 
                ...
                className="w-full bg-surface border border-red-200 text-red-600 font-bold py-3.5 rounded-2xl hover:bg-red-50 transition text-xs flex items-center justify-center gap-1 mt-4"
              >
                <RotateCcw size={14} />
                <span>データを最初からやり直す</span>
              </button>
            </div>
          </div>
        )}
      ...
      {/* ========================================================= */}
      {/* ボトムナビゲーションバー（4タブにスッキリ整理） */}
      {/* ========================================================= */}
      <div className="fixed bottom-0 left-1/2 -translate-x-1/2 w-full max-w-[440px] bg-surface/95 backdrop-blur-md border-t border-borderSubtle h-16 flex items-center justify-around px-3 z-50">
        {[

...
import com.mikke.discovery.shared.discovery.MyDataSettings
import com.mikke.discovery.shared.discovery.ReportType
...
class DiscoveryPeriodicReportWorkerTest {
    ...
    fun 週次APIが失敗しても月次は通知され月次キーのみ更新される() = runBlocking {
        ...
        val failingRepo = object : DiscoveryRepository by FakeDiscoveryRepository(enableArtificialDelay = false) {
            override suspend fun getWeeklyNarrative(): com.mikke.discovery.shared.discovery.WeeklyNarrative {
    ...
    fun 月次APIが失敗しても週次は通知され週次キーのみ更新される() = runBlocking {
        ...
        val failingRepo = object : DiscoveryRepository by FakeDiscoveryRepository(enableArtificialDelay = false) {
            override suspend fun getMonthlyNarrative(): com.mikke.discovery.shared.discovery.MonthlyNarrative {
    ...
    fun マイルストーンAPIが失敗しても他の通知は継続する() = runBlocking {
        ...
        val failingRepo = object : DiscoveryRepository by FakeDiscoveryRepository(enableArtificialDelay = false) {
            override suspend fun getMilestoneNarrative(): com.mikke.discovery.shared.discovery.MilestoneNarrative {
